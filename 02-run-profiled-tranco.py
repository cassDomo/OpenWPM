...
# --- Run 1 browser profiled against tranco list top 20 ---
...
if args.tranco:
    ...
    latest_list = t.list()
    targetSites = ["http://" + x for x in latest_list.top(20)]
...
def visitSeedSites():
    browser_param.profile_archive_dir = Path("./profilestore/")
    visitSites(seedAddresses)
    TaskManager.close
